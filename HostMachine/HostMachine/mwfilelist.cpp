...
static const char *c_sTaskQuery = QT_TRANSLATE_NOOP("MWFileList", "任务查询");
...
// 分区停止结果
static const char *c_sAreaStopResult0 = QT_TRANSLATE_NOOP("MWFileList", "分区停止成功");
static const char *c_sAreaStopResult1 = QT_TRANSLATE_NOOP("MWFileList", "其它运行异常");

// 导入结果
static const char *c_sImportTip = QT_TRANSLATE_NOOP("MWFileList", "%0 -> %1/%2 速度：%3/s 用时：%4s 完成：%p%");
